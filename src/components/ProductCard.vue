  ...
  >
    ...
    <div class="flex gap-2">
      <button 
        ...
        class="flex-1 bg-gray-100 dark:bg-gray-600 bg-opacity-90 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-500 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold rounded transition-colors duration-200 hover:bg-gray-200 dark:hover:bg-gray-500 touch-manipulation"
      >
        詳細
      </button>
      <button 
        @click="$emit('add-to-cart', product)" 
        class="flex-1 bg-primary text-white border-none py-1.5 sm:py-2 text-xs sm:text-sm font-semibold rounded transition-colors duration-200 hover:bg-primary-hover touch-manipulation"
      >
        追加
      </button>
    </div>
